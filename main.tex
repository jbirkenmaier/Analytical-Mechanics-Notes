...
As you might recall, a Taylor expansion is a way to represent a function as a polynomial. We use this because dealing with polynomials is oftentimes easier than working with the original function. The formula for the one-dimensional Taylor expansion is given by: 
\begin{align}
